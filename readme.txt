=== Post CoAuthors ===
Contributors: kajalgohel
Donate link: https://profiles.wordpress.org/kajalgohel/
Tags: contributors, multiple authors, user roles
...
= 1.0 =
Initial release of Post CoAuthors.

== Credits ==

Developed by Kajal Gohel.  
Based on guidance from the [WordPress Plugin Developer Handbook](https://developer.wordpress.org/plugins/).
